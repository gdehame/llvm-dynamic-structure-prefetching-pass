...
void Symbol_264(Symbol_5 *Symbol_1093)
{
  ...
  while (Symbol_646 != ((void *)0)) {
    ...
    {if ((Symbol_879->Symbol_857.Symbol_474 != Symbol_0)) continue;}; // always fail
...
__attribute__ ((noinline))
static uint32_t Symbol_274(const Symbol_74 *Symbol_1108)
{
  uint32_t hash = 0;
  uint16_t Symbol_664 = (uint16_t)Symbol_21();
  do { if (((__builtin_expect((!!((Symbol_1108) == ((void *)0))), 0)))) { return hash; } } while (0);
...
int main(int argc, char **argv) {
  ...
  Symbol_2(Symbol_1093, element_num);
  ...
  RMS_Start_Transaction();
  uint32_t hash = Symbol_274(Symbol_1108);
  RMS_End_Transaction();
  printf("Done 3. %d %d\n", hash, (hash >> 16));
#endif

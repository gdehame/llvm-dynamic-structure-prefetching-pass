...
static inline void Symbol_227(Symbol_5 *Symbol_645, NodeC *Symbol_692)
{
  ...
  if (Symbol_645->ListNode == Symbol_692) {
    if (Symbol_645->Symbol_651 != Symbol_692) {
      Symbol_645->ListNode = Symbol_692->next;
...
typedef struct 
{
  Symbol_304 * Symbol_377;
  Symbol_304 * Symbol_647;
  uint32_t num_iter;
  int init;
} ht_param;

void ht_1_init(void * x)
{
  Symbol_304 * Symbol_377_ht = ((ht_param*)x)->Symbol_377;
  Symbol_304 * Symbol_647_ht = ((ht_param*)x)->Symbol_647;
  if (((ht_param*)x)->init)
  {
    for (int i = 0; i < LIMIT; i++)
    {
      {if ((Symbol_377_ht == Symbol_647_ht || ((__builtin_expect((!!((Symbol_377_ht) == ((void *)0))), 0))))) break;};
      __builtin_prefetch(&(Symbol_377_ht->position),0,0);
      Symbol_377_ht = (Symbol_304*)(Symbol_377_ht->ListNode.next);
    }
    ((ht_param*)x)->init = 0;
    ((ht_param*)x)->Symbol_377 = Symbol_377_ht;
  }
}
...
void * ht_1(void * x)
{
  ...
  uint32_t num_iter = ((ht_param*)x)->num_iter - LIMIT;
  for (uint32_t i = 0; i < num_iter; i++)
  {
    {if ((Symbol_377_ht == Symbol_647_ht || ((__builtin_expect((!!((Symbol_377_ht) == ((void *)0))), 0))))) break;};
    __builtin_prefetch(&(Symbol_377_ht->position),0,0);
    Symbol_304* p = Symbol_377_ht;
    Symbol_377_ht = (Symbol_304*)(Symbol_377_ht->ListNode.next);
    __builtin_prefetch(&(p->ListNode.next),0,0);
  }
  pthread_exit(NULL);
  return NULL;
}
...
static uint32_t Benchmark1(const OutStringStruct *OutputString, NodeBContainer *MainList1)
{
  ...
  for (uint32_t i = 0; i < num_iter; i++) {
    ...
    Symbol_69 *Symbol_879 = Symbol_236(Symbol_377->position); //TARGET
...
typedef struct ht2_t
{
  Symbol_5 * Symbol_645;
  NodeC * Symbol_692;
  NodeC * Symbol_692_next;
  NodeC * Symbol_645_Symbol_651;
  NodeC * Symbol_645_ListNode;
  int init;
} ht2_params;

void ht_2_init(void * x)
{
  Symbol_5* Symbol_645 = ((ht2_params*) x)->Symbol_645;
  NodeC* Symbol_692 = ((ht2_params*) x)->Symbol_692;
  int init = ((ht2_params*)x)->init;
  if (init)
  {
    NodeC * Symbol_692_next = Symbol_692->next;
    NodeC * Symbol_645_Symbol_651 = Symbol_645->Symbol_651;
    NodeC * Symbol_645_ListNode = Symbol_645->ListNode;
    for (int i = 0; i < LIMIT; i++)
    {
      uint32_t position = ((Symbol_308*)Symbol_692)->position;
      if (!((((__builtin_expect((!!((Symbol_645) == ((void *)0))), 0))) || ((__builtin_expect((!!((Symbol_692) == ((void *)0))), 0))))))
      {
        if (Symbol_645_ListNode == Symbol_692) 
        {
          if (Symbol_645_Symbol_651 != Symbol_692) 
          {
            Symbol_645_ListNode = Symbol_692_next;
            if (!((__builtin_expect((!!((Symbol_692_next) == ((void *)0))), 0)))) 
            {
              Symbol_692_next = ((void *)0);
            }
          } 
          else 
          {
            Symbol_645_ListNode = ((void *)0);
            Symbol_645_Symbol_651 = ((void *)0);
          }
          Symbol_692_next = ((void *)0);
        }
        else if (Symbol_645_Symbol_651 == Symbol_692) 
        {
          Symbol_645_Symbol_651 = Symbol_692->prev;
          Symbol_692_next = ((void *)0);
        }
        else
        {
      ...
      if (!(((((__builtin_expect((!!((structure_of_interest) == ((void *)0))), 0)))) || (position >= getNumIter()))))
      {
        Symbol_879 = structure_of_interest + position;
      }
      if (!((((__builtin_expect((!!((Symbol_879) == ((void *)0))), 0))))))
      {
        if (!((Symbol_879->Symbol_857.Symbol_474 != Symbol_0)))
        {
          Symbol_692 = Symbol_645_ListNode;
          Symbol_692_next = Symbol_692->next;
        }
        __builtin_prefetch(&(Symbol_879->Symbol_857.Symbol_474),0,0);
      }
    } 
    ht2_params * res = (ht2_params*) x;
    res->Symbol_645 = Symbol_645;
    res->Symbol_692 = Symbol_692;
    res->Symbol_692_next = Symbol_692_next;
    res->Symbol_645_Symbol_651 = Symbol_645_Symbol_651;
    res->Symbol_645_ListNode = Symbol_645_ListNode;
    res->init = 0;
  }
}
...
void * ht_2(void* x)
{
  ...
  int i = 0;
  while (Symbol_692 != ((void *)0))
  {
    i++;
    uint32_t position = ((Symbol_308*)Symbol_692)->position;
    if (structure_of_interest && position < getNumIter())
    {
      Symbol_69* Symbol_879 = structure_of_interest + position;
      __builtin_prefetch(&(Symbol_879->Symbol_857.Symbol_474),0,0);
    }
    Symbol_692 = Symbol_692->next;
  }
  printf("%d\n",i);
  pthread_exit(NULL);
  return NULL;
...
void Benchmark2(Symbol_5 *MainList2)
{
  ...
  while (ListNode != ((void *)0)) {
    ...
    uint32_t position = Symbol_1164->position;
    ...
    {if ((Symbol_879->Symbol_857.Symbol_474 != Symbol_0)) continue;}; // target
...
int main(int argc, char **argv) {
  ...
  CPU_SET(4,&cpuSetHT);
  pthread_setaffinity_np(pthread_self(),8,&cpuSetMain);
  
  ht_param * ht_init = (ht_param*) malloc(sizeof(ht_param));
  ht_init->Symbol_647 = (Symbol_304*)&MainList1->ListNode;
  ht_init->init = 1;
  ht_init->num_iter = getNumIter();
  ht_init->Symbol_377 = (Symbol_304*)MainList1->ListNode.next;
  (void)ht_1_init(ht_init);
  pthread_create(&thread_id, NULL, ht_1, ht_init);
  pthread_setaffinity_np(thread_id,8,&cpuSetHT);
  ...
  CPU_SET(4,&cpuSetHT);
  pthread_setaffinity_np(pthread_self(),8,&cpuSetMain);
  ht2_params * ht_init = (ht2_params*) malloc(sizeof(ht2_params));
  ht_init->Symbol_692 = (NodeC*)MainList2->ListNode;
  ht_init->Symbol_645 = (Symbol_5*)MainList2;
  ht_init->init = 1;
  (void) ht_2_init(ht_init);
  //pthread_barrier_init(&barrier, NULL, 2);
  pthread_create(&thread_id, NULL, ht_2, ht_init);
  pthread_setaffinity_np(thread_id,8,&cpuSetHT);

...
define dso_local void @RMS_Start_Transaction() local_unnamed_addr #0 !dbg !319 {
  tail call void asm sideeffect "nop", "~{dirflag},~{fpsr},~{flags}"() #22, !dbg !323, !srcloc !324
  ret void, !dbg !325
}

; Function Attrs: noinline nounwind uwtable
define dso_local void @RMS_End_Transaction() local_unnamed_addr #0 !dbg !326 {
  tail call void asm sideeffect "nop", "~{dirflag},~{fpsr},~{flags}"() #22, !dbg !327, !srcloc !328
  ret void, !dbg !329
}
...
12:                                               ; preds = %6
  ...
  %14 = tail call noalias ptr @malloc(i64 noundef %13) #23, !dbg !387
...
15:                                               ; preds = %8
  ...
  %17 = tail call noalias ptr @malloc(i64 noundef %16) #23, !dbg !429
...
4:                                                ; preds = %2
  ...
  call void @llvm.dbg.value(metadata ptr null, metadata !552, metadata !DIExpression()), !dbg !580
  call void @llvm.dbg.value(metadata i32 0, metadata !573, metadata !DIExpression()), !dbg !581
  %7 = tail call noalias dereferenceable_or_null(128) ptr @calloc(i64 noundef 1, i64 noundef 128) #24, !dbg !584
...
.preheader:                                       ; preds = %23, %.preheader
  ...
  %28 = tail call noalias dereferenceable_or_null(128) ptr @calloc(i64 noundef 1, i64 noundef 128) #24, !dbg !584
...
32:                                               ; preds = %31
  tail call void @__assert_fail(ptr noundef nonnull @.str.4, ptr noundef nonnull @.str.5, i32 noundef 249, ptr noundef nonnull @__PRETTY_FUNCTION__.Symbol_227) #25, !dbg !731
  unreachable, !dbg !731
...
8:                                                ; preds = %24, %4
  ...
  %12 = tail call noalias dereferenceable_or_null(24) ptr @calloc(i64 noundef 1, i64 noundef 24) #24, !dbg !842
...
.preheader4.preheader:                            ; preds = %.preheader6
  ...
  %12 = tail call noalias ptr @malloc(i64 noundef %11) #23, !dbg !916
...
.preheader3:                                      ; preds = %16, %32
  ...
  %19 = tail call i32 @rand() #22, !dbg !926
...
23:                                               ; preds = %.preheader3
  ...
  %25 = tail call i32 @rand() #22, !dbg !931
...
.loopexit:                                        ; preds = %.preheader, %.loopexit3, %.thread
  ...
  tail call void @free(ptr noundef nonnull %12) #22, !dbg !961
  ret void, !dbg !962
...
.preheader4.preheader:                            ; preds = %.preheader6
  ...
  %13 = tail call noalias ptr @malloc(i64 noundef %12) #23, !dbg !1001
...
.preheader5:                                      ; preds = %17, %33
  ...
  %20 = tail call i32 @rand() #22, !dbg !1012
...
24:                                               ; preds = %.preheader5
  ...
  %26 = tail call i32 @rand() #22, !dbg !1017
...
.loopexit:                                        ; preds = %.preheader, %.loopexit3, %.thread
  ...
  tail call void @free(ptr noundef nonnull %13) #22, !dbg !1048
  ret void, !dbg !1049
...
define dso_local i32 @main(i32 noundef %0, ptr nocapture noundef readonly %1) local_unnamed_addr #14 !dbg !1052 {
  ...
  %7 = tail call i64 @strtol(ptr nocapture noundef nonnull %6, ptr noundef null, i32 noundef 10) #22, !dbg !1084
...
19:                                               ; preds = %12
  ...
  %21 = tail call noalias ptr @malloc(i64 noundef %20) #23, !dbg !1123
...
23:                                               ; preds = %19
  ...
  %24 = tail call noalias dereferenceable_or_null(80036) ptr @calloc(i64 noundef 1, i64 noundef 80036) #24, !dbg !1129
...
.loopexit:                                        ; preds = %pred.store.if20, %pred.store.continue19, %.loopexit3, %23
  ...
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %3) #22, !dbg !1145
  call void @llvm.dbg.declare(metadata ptr %3, metadata !1063, metadata !DIExpression()), !dbg !1146
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %4) #22, !dbg !1145
  call void @llvm.dbg.declare(metadata ptr %4, metadata !1073, metadata !DIExpression()), !dbg !1147
  %68 = call i32 @clock_gettime(i32 noundef 1, ptr noundef nonnull %3) #22, !dbg !1148
  ...
  %70 = call i32 @clock_gettime(i32 noundef 1, ptr noundef nonnull %4) #22, !dbg !1150
  ...
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %4) #22, !dbg !1169
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %3) #22, !dbg !1169
  br label %113
...
19:                                               ; preds = %43, %17
  %20 = phi i32 [ 0, %17 ], [ %44, %43 ]
  %21 = phi i64 [ 0, %17 ], [ %22, %43 ]
  %22 = add nuw nsw i64 %21, 1, !dbg !1221
  %23 = getelementptr inbounds %struct.Array3, ptr %0, i64 0, i32 4, i64 %22, !dbg !1222
  tail call void @llvm.prefetch.p0(ptr nonnull %23, i32 0, i32 0, i32 1)
  call void @llvm.dbg.value(metadata i32 %20, metadata !1194, metadata !DIExpression()), !dbg !1207
  call void @llvm.dbg.value(metadata i64 %21, metadata !1201, metadata !DIExpression()), !dbg !1218
  %24 = getelementptr inbounds %struct.Array3, ptr %0, i64 0, i32 4, i64 %21, !dbg !1222
  %25 = load i16, ptr %24, align 2, !dbg !1223, !tbaa !1137
  call void @llvm.dbg.value(metadata i16 %25, metadata !1203, metadata !DIExpression()), !dbg !1224
  %26 = zext i16 %25 to i32, !dbg !1225
  call void @llvm.dbg.value(metadata i32 %26, metadata !445, metadata !DIExpression()), !dbg !1226
  %27 = icmp ugt i32 %2, %26
  call void @llvm.dbg.value(metadata ptr poison, metadata !1206, metadata !DIExpression()), !dbg !1224
  br i1 %27, label %28, label %43, !dbg !1228, !prof !1230

28:                                               ; preds = %19
  %29 = zext i16 %25 to i64, !dbg !1231
  %30 = getelementptr inbounds %struct.Symbol_69, ptr %15, i64 %29, i32 2, i32 4, !dbg !1232
  %31 = load i16, ptr %30, align 8, !dbg !1232, !tbaa !1233, !annotation !318
  %32 = getelementptr inbounds %struct.Symbol_69, ptr %15, i64 %29, i32 2, i32 2, !dbg !1234
  %33 = load i32, ptr %32, align 8, !dbg !1234, !tbaa !1235
  %34 = getelementptr inbounds %struct.Array3, ptr %0, i64 0, i32 4, i64 %21, i32 1, !dbg !1236
  %35 = load i8, ptr %34, align 2, !dbg !1236, !tbaa !1237
  %36 = zext i16 %31 to i32, !dbg !1238
  %37 = zext i8 %35 to i32, !dbg !1239
  %38 = add i32 %20, 65536, !dbg !1240
  %39 = add i32 %38, %26, !dbg !1241
  %40 = add i32 %39, %36, !dbg !1242
  %41 = add i32 %40, %33, !dbg !1243
  %42 = add i32 %41, %37, !dbg !1244
  call void @llvm.dbg.value(metadata i32 %42, metadata !1194, metadata !DIExpression()), !dbg !1207
  br label %43, !dbg !1245

43:                                               ; preds = %28, %19
  %44 = phi i32 [ %42, %28 ], [ %20, %19 ], !dbg !1207
  call void @llvm.dbg.value(metadata i32 %44, metadata !1194, metadata !DIExpression()), !dbg !1207
  call void @llvm.dbg.value(metadata i64 %22, metadata !1201, metadata !DIExpression()), !dbg !1218
  %45 = icmp eq i64 %22, %18, !dbg !1219
  br i1 %45, label %.loopexit, label %19, !dbg !1220, !llvm.loop !1246

.loopexit:                                        ; preds = %43, %13, %4, %1
  %46 = phi i32 [ 0, %1 ], [ 0, %4 ], [ 0, %13 ], [ %44, %43 ], !dbg !1207
  ret i32 %46, !dbg !1248
}
...
!1221 = !DILocation(line: 582, column: 39, scope: !1205)
!1222 = !DILocation(line: 583, column: 25, scope: !1204)
!1223 = !DILocation(line: 583, column: 46, scope: !1204)
!1224 = !DILocation(line: 0, scope: !1204)
!1225 = !DILocation(line: 584, column: 40, scope: !1204)
!1226 = !DILocation(line: 0, scope: !441, inlinedAt: !1227)
!1227 = distinct !DILocation(line: 584, column: 29, scope: !1204)
!1228 = !DILocation(line: 585, column: 10, scope: !1229)
!1229 = distinct !DILexicalBlock(scope: !1204, file: !3, line: 585, column: 5)
!1230 = !{!"branch_weights", i32 2000, i32 1}
!1231 = !DILocation(line: 319, column: 85, scope: !448, inlinedAt: !1227)
!1232 = !DILocation(line: 586, column: 54, scope: !1204)
!1233 = !{!477, !482, i64 104}
!1234 = !DILocation(line: 588, column: 54, scope: !1204)
!1235 = !{!477, !481, i64 88}
!1236 = !DILocation(line: 589, column: 52, scope: !1204)
!1237 = !{!1138, !452, i64 2}
!1238 = !DILocation(line: 590, column: 13, scope: !1204)
!1239 = !DILocation(line: 590, column: 91, scope: !1204)
!1240 = !DILocation(line: 590, column: 37, scope: !1204)
!1241 = !DILocation(line: 590, column: 63, scope: !1204)
!1242 = !DILocation(line: 590, column: 89, scope: !1204)
!1243 = !DILocation(line: 590, column: 115, scope: !1204)
!1244 = !DILocation(line: 590, column: 10, scope: !1204)
!1245 = !DILocation(line: 591, column: 3, scope: !1205)
